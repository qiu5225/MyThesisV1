...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/HHO/gauss.jpg
    } % 调整宽度为适合您文档的值
...
\begin{equation}
    {\sigma }_{t} = {\sigma }_{0} \times  \left( {1 - \frac{t}{T}}\right) \tag{22}
\end{equation}
