...
\subsubsection{实验准备}
所有参与算法的参数设置均统一，种群规模为N=30，每次运行的最大计算预算为3000次迭代。算法的参数设置详情严格按照表\ref{tb:FS-alg-parameters-2} 中所列的进行实验。本研究所用的所有实验数据集均来自医学领域。数据集包括 8 个中低维度和 4 个高维度数据集，涵盖多样的数据特性，以严格测试算法的可扩展性和鲁棒性。这些数据集的详细规格（如样本量、特征维度和类别分布）见表\ref{tb:irime-datasets-info}。此分层数据设计旨在验证IRIME在不同问题复杂度下的表现，同时保持其在医学应用中的实际相关性。实验的软、硬件则与前文一直，严格按照 \ref{sec:exp-settings} 节中的软硬件环境进行实验。
%算法参数设置表2
\begin{table}[htbp]
\centering
\small
...
\begin{table}[htbp]
  ...
  \bicaption{各算法弗里德曼排名结果（10维）}{Friedman ranking results for each algorithm (10D)}
    ...
    \midrule
    F1  & 1     & 2.03  & 5     & 3.93  & 3.03  & 6 \\
    F2  & 1     & 2.13  & 4.97  & 2.93  & 3.97  & 6 \\
    F3  & 1     & 2.7   & 4.23  & 4.67  & 2.4   & 6 \\
    F4  & 3.42  & 3.42  & 3.42  & 3.42  & 3.92  & 3.42 \\
    F5  & 1.33  & 2.2   & 5     & 3.6   & 2.87  & 6 \\
    F6  & 1.13  & 2.83  & 4.23  & 4.77  & 2.03  & 6 \\
    F7  & 1     & 3.1   & 5     & 2.23  & 3.67  & 6 \\
    F8  & 1.1   & 2.1   & 4     & 5     & 2.8   & 6 \\
    F9  & 2.03  & 4.43  & 1.43  & 4.2   & 3.1   & 5.8 \\
    F10 & 1.37  & 1.67  & 4.97  & 3.97  & 3.03  & 6 \\
    \bottomrule
    \end{tabular}%
...
\begin{table}[htbp]
  ...
  \bicaption{各算法弗里德曼排名结果（30维）}{Friedman ranking results for each algorithm (30D)}
    ...
    函数    & IHHO  & HHO   & BWO   & AOA   & SCA   & RSA \\
    \midrule
    F1  & 1     & 2     & 5     & 4.23  & 3     & 5.77 \\
    F2  & 1     & 2     & 5.13  & 3     & 5.87  & 4 \\
    F3  & 1     & 2.97  & 5     & 4     & 2.03  & 6 \\
    F4  & 3.47  & 3.47  & 3.47  & 3.47  & 3.67  & 3.47 \\
    F5  & 1     & 2     & 5     & 3.67  & 3.33  & 6 \\
    F6  & 1     & 2.03  & 5.13  & 3.67  & 3.5   & 5.67 \\
    F7  & 1     & 2     & 5     & 3.07  & 3.93  & 6 \\
    F8  & 1     & 2.07  & 3.87  & 4.6   & 4.97  & 4.5 \\
    F9  & 1     & 3.93  & 4.6   & 5.97  & 2.03  & 3.47 \\
    F10 & 1.03  & 1.97  & 4.27  & 4.77  & 3     & 5.97 \\
    \bottomrule
    \end{tabular}%
...
\begin{table}[htbp]
  ...
  \bicaption{IHHO与其他五种算法适应度值统计结果及Friedman排名}{Friedman ranking of fitness statistical results between IHHO and other five algorithms}
    ...
    \midrule
    \multirow{3}[1]{*}{Breast} & mean  & 0.1095185 & 0.1515644 & 0.1354936 & 0.3180502 & 0.210044 & 0.2916738 \\
          & std   & 0.0670097 & 0.0523895 & 0.0268912 & 0.0736107 & 0.05504 & 0.0706456 \\
          & rank  & 1.3   & 2.5   & 2.2   & 5.8   & 4     & 5.2 \\
    \multirow{3}[0]{*}{CNS} & mean  & 0.0331278 & 0.0661376 & 0.1074357 & 0.2042 & 0.0427415 & 0.1782782 \\
          & std   & 0.0425155 & 0.0521832 & 0.0555916 & 0.0968233 & 0.0434474 & 0.0465634 \\
          & rank  & 1     & 2.4   & 3.7   & 5.8   & 2.9   & 5.2 \\
    \multirow{3}[0]{*}{Colon} & mean  & 0.0167085 & 0.03337 & 0.033016 & 0.063079 & 0.0174025 & 0.161648 \\
          & std   & 0.0346824 & 0.0425333 & 0.0425944 & 0.05594 & 0.0348197 & 0.0987491 \\
          & rank  & 1.9   & 3.25  & 1.55  & 5     & 3.3   & 6 \\
    \multirow{3}[0]{*}{Leukemia} & mean  & 5.61E-05 & 0.0004744 & 0.0002075 & 0.0124291 & 0.0009165 & 0.0121184 \\
          & std   & 9.36E-05 & 0.0011926 & 0.0002758 & 0.0228747 & 0.000614 & 0.0223038 \\
          & rank  & 1.3   & 2.8   & 2     & 5.4   & 3.9   & 5.6 \\
    \multirow{3}[0]{*}{Leukemia\_3c} & mean  & 7.14E-05 & 0.0216288 & 0.007364 & 0.0828305 & 0.0007914 & 0.0404696 \\
          & std   & 0.0001025 & 0.0343208 & 0.0222641 & 0.0618259 & 0.0001477 & 0.0498675 \\
          & rank  & 1     & 3.35  & 2.25  & 6     & 3.4   & 5 \\
    \multirow{3}[0]{*}{Leukemia\_4c} & mean  & 0.078073 & 0.0784658 & 0.0786582 & 0.0834406 & 0.0645974 & 0.1322613 \\
          & std   & 0.0518116 & 0.0393294 & 0.0399362 & 0.0397439 & 0.0520235 & 0.0446829 \\
          & rank  & 2     & 2.9   & 2.3   & 4.9   & 2.9   & 6 \\
    \multirow{3}[0]{*}{Lung} & mean  & 0.0176599 & 0.0140798 & 0.0288082 & 0.0226636 & 0.0160743 & 0.0374821 \\
          & std   & 0.0203119 & 0.0139243 & 0.0184428 & 0.0166918 & 0.0210012 & 0.0330352 \\
          & rank  & 1.4   & 2.2   & 4.5   & 4.6   & 2.7   & 5.6 \\
    \multirow{3}[1]{*}{Ovarian} & mean  & 0.0079396 & 0.009917 & 0.0059459 & 0.0704009 & 0.0383135 & 0.058423 \\
          & std   & 0.0138447 & 0.010442 & 0.0095637 & 0.0493034 & 0.0302266 & 0.0229762 \\
          & rank  & 2     & 2.55  & 1.45  & 5.5   & 4     & 5.5 \\
    \bottomrule
    \end{tabular}%
...
\begin{table}[htbp]
  ...
  \bicaption{IHHO与其他五种算法准确率统计结果及Friedman排名}{Friedman ranking of accuracy statistical results between IHHO and other five algorithms}
    ...
    数据集   & 类型    & IHHO  & HHO   & BWO   & AOA   & SCA   & RSA \\
    \midrule
    \multirow{3}[1]{*}{Breast} & mean  & 0.8894737 & 0.8473684 & 0.8631579 & 0.6842105 & 0.7894737 & 0.7105263 \\
          & std   & 0.0677202 & 0.0523384 & 0.0271788 & 0.0744323 & 0.0554786 & 0.0712635 \\
          & rank  & 1.4   & 2.5   & 2.2   & 5.7   & 3.9   & 5.3 \\
    \multirow{3}[0]{*}{CNS} & mean  & 0.9666667 & 0.9333333 & 0.8916667 & 0.8   & 0.9583333 & 0.825 \\
          & std   & 0.0430331 & 0.0527046 & 0.0562457 & 0.0978156 & 0.0439205 & 0.0473039 \\
          & rank  & 1.8   & 2.6   & 3.75  & 5.55  & 2     & 5.3 \\
    \multirow{3}[0]{*}{Colon} & mean  & 0.9833333 & 0.9666667 & 0.9666667 & 0.9416667 & 0.9833333 & 0.8416667 \\
          & std   & 0.0351364 & 0.0430331 & 0.0430331 & 0.0562457 & 0.0351364 & 0.0997683 \\
          & rank  & 2.6   & 3.1   & 3.1   & 3.85  & 2.6   & 5.75 \\
    \multirow{3}[0]{*}{Leukemia} & mean  & 1     & 1     & 1     & 0.9928571 & 1     & 0.9928571 \\
          & std   & 0     & 0     & 0     & 0.0225877 & 0     & 0.0225877 \\
          & rank  & 3.4   & 3.4   & 3.4   & 3.7   & 3.4   & 3.7 \\
    \multirow{3}[0]{*}{Leukemia\_3c} & mean  & 1     & 0.9785714 & 0.9928571 & 0.9214286 & 1     & 0.9642857 \\
          & std   & 0     & 0.0345033 & 0.0225877 & 0.0625425 & 0     & 0.0505076 \\
          & rank  & 2.7   & 3.45  & 2.9   & 5.35  & 2.7   & 3.9 \\
    \multirow{3}[0]{*}{Leukemia\_4c} & mean  & 0.9214286 & 0.9214286 & 0.9214286 & 0.9214286 & 0.9357143 & 0.8714286 \\
          & std   & 0.0527046 & 0.0405462 & 0.0405462 & 0.0405462 & 0.0527046 & 0.0451754 \\
          & rank  & 3.25  & 3.25  & 3.25  & 3.25  & 2.65  & 5.35 \\
    \multirow{3}[0]{*}{Lung} & mean  & 0.9825 & 0.9875 & 0.9725 & 0.9825 & 0.985 & 0.9675 \\
          & std   & 0.0205818 & 0.0131762 & 0.0184466 & 0.0168737 & 0.0210819 & 0.0334373 \\
          & rank  & 3.2   & 2.65  & 4.4   & 3.2   & 2.95  & 4.6 \\
    \multirow{3}[1]{*}{Ovarian} & mean  & 0.992 & 0.99  & 0.994 & 0.934 & 0.962 & 0.946 \\
          & std   & 0.0139841 & 0.0105409 & 0.0096609 & 0.0499333 & 0.0304777 & 0.02319 \\
          & rank  & 2.15  & 2.3   & 2     & 5.4   & 3.85  & 5.3 \\
    \bottomrule
    \end{tabular}%
  \label{tb:IHHO-acc}%
\end{table}%
